...
public class Homepage 
{
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[2]/div/div/div[2]/div[1]/div[1]/div[1]/div/div/div/input")).sendKeys("Mum");     //typing input in the box
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		...
		driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[2]/div/div/div[2]/div[1]/div[2]/div[1]/div/div/div[1]/input")).sendKeys("Che");     //typing input in the box
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		...
		driver.findElement(By.xpath("//div[@class=\"appendBottom20\"]/ul/li[3]")).click();          //Selecting no. of adults
